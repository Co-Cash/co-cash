...
contract COToken is Context, IERC20, Ownable {
    ...
    address public walletPerformance = 0x8CaCE1cd117CBF2BB9F7800a8F9d6130f84e5B29;
    address public walletCharity = 0x8CaCE1cd117CBF2BB9F7800a8F9d6130f84e5B29;
    address public walletCommunity = 0xB56fdb35dBA46cC547177c61542ef4b1aD5926f6;

    COLiquidityDrive public liquidityDrive;
    uint256 public immutable _campaignPeriod = 10 days;
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        if(tLiquidityNCharityNCommunity > 0)
